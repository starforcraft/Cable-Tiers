...
public class CreativeExporterScreen extends BaseScreen<CreativeExporterContainer>
{
    private boolean hasRegulatorMode;

    public CreativeExporterScreen(CreativeExporterContainer container, PlayerInventory inventory, ITextComponent title)
    {
    ...
    {
        addSideButton(new RedstoneModeSideButton(this, CreativeExporterTileEntity.REDSTONE_MODE));
        addSideButton(new TypeSideButton(this, CreativeExporterTileEntity.TYPE));
        addSideButton(new ExactModeSideButton(this, CreativeExporterTileEntity.COMPARE));
    }
