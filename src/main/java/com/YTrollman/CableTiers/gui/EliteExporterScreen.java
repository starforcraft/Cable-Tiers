...
public class EliteExporterScreen extends BaseScreen<EliteExporterContainer>
{
    private boolean hasRegulatorMode;

    public EliteExporterScreen(EliteExporterContainer container, PlayerInventory inventory, ITextComponent title)
    {
    ...
    {
        addSideButton(new RedstoneModeSideButton(this, EliteExporterTileEntity.REDSTONE_MODE));
        addSideButton(new TypeSideButton(this, EliteExporterTileEntity.TYPE));
        addSideButton(new ExactModeSideButton(this, EliteExporterTileEntity.COMPARE));
    }
