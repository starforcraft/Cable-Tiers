...
public class UltraDestructorNetworkNode extends NetworkNode implements IComparable, IWhitelistBlacklist, IType {
    public static final ResourceLocation ID = new ResourceLocation(CableTiers.MOD_ID, "ultra_destructor");
    ...
    private static final int BASE_SPEED = 20 / CableConfig.ULTRA_DESTRUCTOR_SPEED.get();
    ...
    public UltraDestructorNetworkNode(World world, BlockPos pos) {
        super(world, pos);
    }
