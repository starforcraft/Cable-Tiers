...
public class EliteExporterNetworkNode extends NetworkNode implements IComparable, IType {
    public static final ResourceLocation ID = new ResourceLocation(CableTiers.MOD_ID, "elite_exporter");

    private static final String NBT_COMPARE = "Compare";
    private static final String NBT_TYPE = "Type";
    private static final String NBT_FLUID_FILTERS = "FluidFilters";

    private int faster = CableConfig.ELITE_EXPORTER_SPEED.get();
    ...
    public EliteExporterNetworkNode(World world, BlockPos pos)
    {
        super(world, pos);
    }
    ...
    public int getType()
    {
        return world.isClientSide ? EliteExporterTileEntity.TYPE.getValue() : type;
    }
