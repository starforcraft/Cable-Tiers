...
public class EliteConstructorNetworkNode extends NetworkNode implements IComparable, IType {
    public static final ResourceLocation ID = new ResourceLocation(CableTiers.MOD_ID, "elite_constructor");
    ...
    private static final int BASE_SPEED = 20 / CableConfig.ELITE_CONSTRUCTOR_SPEED.get();
    ...
    public EliteConstructorNetworkNode(World world, BlockPos pos) {
        super(world, pos);
    }
    ...
    @Override
    public int getType() {
        return world.isClientSide ? EliteConstructorTileEntity.TYPE.getValue() : type;
    }
