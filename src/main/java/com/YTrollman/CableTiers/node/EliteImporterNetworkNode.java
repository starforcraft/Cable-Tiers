...
public class EliteImporterNetworkNode extends NetworkNode implements IComparable, IWhitelistBlacklist, IType {
    public static final ResourceLocation ID = new ResourceLocation(CableTiers.MOD_ID, "elite_importer");
    ...
    private int faster = CableConfig.ELITE_IMPORTER_SPEED.get();
    ...
    public EliteImporterNetworkNode(World world, BlockPos pos)
    {
        super(world, pos);
    }
