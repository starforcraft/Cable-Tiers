...
public class CreativeExporterNetworkNode extends NetworkNode implements IComparable, IType {
    public static final ResourceLocation ID = new ResourceLocation(CableTiers.MOD_ID, "creative_exporter");
    ...
    private final UpgradeItemHandler upgrades = (UpgradeItemHandler) new UpgradeItemHandler(4, UpgradeItem.Type.CRAFTING, UpgradeItem.Type.REGULATOR)
    ...
    public CreativeExporterNetworkNode(World world, BlockPos pos)
    {
        super(world, pos);
    }
