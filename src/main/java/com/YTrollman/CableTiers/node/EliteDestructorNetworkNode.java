...
public class EliteDestructorNetworkNode extends NetworkNode implements IComparable, IWhitelistBlacklist, IType {
    public static final ResourceLocation ID = new ResourceLocation(CableTiers.MOD_ID, "elite_destructor");
    ...
    private static final int BASE_SPEED = 20 / CableConfig.ELITE_DESTRUCTOR_SPEED.get();
    ...
    public EliteDestructorNetworkNode(World world, BlockPos pos) {
        super(world, pos);
    }
    ...
    @Override
    public int getType() {
        return world.isClientSide ? EliteDestructorTileEntity.TYPE.getValue() : type;
    }
