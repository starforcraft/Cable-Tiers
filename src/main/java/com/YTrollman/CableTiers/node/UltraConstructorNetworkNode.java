...
public class UltraConstructorNetworkNode extends NetworkNode implements IComparable, IType {
    public static final ResourceLocation ID = new ResourceLocation(CableTiers.MOD_ID, "ultra_constructor");
    ...
    private static final int BASE_SPEED = 20 / CableConfig.ULTRA_CONSTRUCTOR_SPEED.get();
    ...
    private final UpgradeItemHandler upgrades = (UpgradeItemHandler) new UpgradeItemHandler(4, UpgradeItem.Type.SPEED, UpgradeItem.Type.CRAFTING)
    ...
    public UltraConstructorNetworkNode(World world, BlockPos pos) {
        super(world, pos);
    }
    ...
    @Override
    public int getType() {
        return world.isClientSide ? UltraConstructorTileEntity.TYPE.getValue() : type;
    }
