...
public class ModItems {
    ...
    public static final RegistryObject<Item> ELITE_IMPORTER_ITEM = ITEMS.register("elite_importer", () -> new BaseBlockItem(ModBlocks.ELITE_IMPORTER.get(), new Item.Properties().tab(RS.MAIN_GROUP)));
    ...
    public static final RegistryObject<Item> ULTRA_IMPORTER_ITEM = ITEMS.register("ultra_importer", () -> new BaseBlockItem(ModBlocks.ULTRA_IMPORTER.get(), new Item.Properties().tab(RS.MAIN_GROUP)));
    ...
    public static final RegistryObject<Item> CREATIVE_IMPORTER_ITEM = ITEMS.register("creative_importer", () -> new BaseBlockItem(ModBlocks.CREATIVE_IMPORTER.get(), new Item.Properties().tab(RS.MAIN_GROUP)));
