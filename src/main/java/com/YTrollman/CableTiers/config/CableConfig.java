...
public class CableConfig {
    ...
    public static void init(ForgeConfigSpec.Builder common) {
        ...
        ULTRA_REQUESTER_MAX_CRAFT_AMOUNT = common.comment("\nUltra Requester Max Craft Amount").defineInRange("ultrarequestermaxcraftamount", 6000, 1, Integer.MAX_VALUE);
        ULTRA_ENERGY_COST = common.comment("\nUltra Energy Cost Multiplier").defineInRange("ultraenergycost", 4, 0, Integer.MAX_VALUE);

        CREATIVE_ENERGY_COST = common.comment("\nCreative Energy Cost Multiplier").defineInRange("creativeenergycost", 0, 0, Integer.MAX_VALUE);
    }
}
