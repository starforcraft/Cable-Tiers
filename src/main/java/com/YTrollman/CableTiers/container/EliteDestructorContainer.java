...
public class EliteDestructorContainer extends BaseContainer {
    public EliteDestructorContainer(EliteDestructorTileEntity destructor, PlayerEntity player, int windowId) {
        super(ModContainers.ELITE_DESTRUCTOR_CONTAINER.get(), destructor, player, windowId);
