...
public class CreativeImporterContainer extends BaseContainer {
    private final CreativeImporterTileEntity tile;

    public CreativeImporterContainer(int windowId, PlayerEntity player, CreativeImporterTileEntity tile)
    {
        super(ModContainers.CREATIVE_IMPORTER_CONTAINER.get(), tile, player, windowId);
        this.tile = tile;
        initSlots();
    }
    ...
    @Override
    public CreativeImporterTileEntity getTile()
    {
        return tile;
    }
}
