...
public class EliteExporterContainer extends BaseContainer {
    private final EliteExporterTileEntity tile;
    private boolean hasRegulatorMode;

    public EliteExporterContainer(int windowId, PlayerEntity player, EliteExporterTileEntity tile)
    {
        super(ModContainers.ELITE_EXPORTER_CONTAINER.get(), tile, player, windowId);
        this.tile = tile;
    ...
    @Override
    public EliteExporterTileEntity getTile()
    {
        return tile;
    }
}
