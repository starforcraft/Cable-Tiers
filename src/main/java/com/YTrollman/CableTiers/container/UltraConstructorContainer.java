...
public class UltraConstructorContainer extends BaseContainer {
    public UltraConstructorContainer(UltraConstructorTileEntity constructor, PlayerEntity player, int windowId) {
        super(ModContainers.ULTRA_CONSTRUCTOR_CONTAINER.get(), constructor, player, windowId);
