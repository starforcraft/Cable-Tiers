...
public class CreativeDestructorContainer extends BaseContainer {
    public CreativeDestructorContainer(CreativeDestructorTileEntity destructor, PlayerEntity player, int windowId) {
        super(ModContainers.CREATIVE_DESTRUCTOR_CONTAINER.get(), destructor, player, windowId);
