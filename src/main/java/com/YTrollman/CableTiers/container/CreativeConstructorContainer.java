...
public class CreativeConstructorContainer extends BaseContainer {
    public CreativeConstructorContainer(CreativeConstructorTileEntity constructor, PlayerEntity player, int windowId) {
        super(ModContainers.CREATIVE_CONSTRUCTOR_CONTAINER.get(), constructor, player, windowId);
