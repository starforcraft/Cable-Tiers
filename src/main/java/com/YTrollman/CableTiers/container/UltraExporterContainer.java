...
public class UltraExporterContainer extends BaseContainer {
    private final UltraExporterTileEntity tile;
    private boolean hasRegulatorMode;

    public UltraExporterContainer(int windowId, PlayerEntity player, UltraExporterTileEntity tile)
    {
        super(ModContainers.ULTRA_EXPORTER_CONTAINER.get(), tile, player, windowId);
        this.tile = tile;
    ...
    @Override
    public UltraExporterTileEntity getTile()
    {
        return tile;
    }
}
