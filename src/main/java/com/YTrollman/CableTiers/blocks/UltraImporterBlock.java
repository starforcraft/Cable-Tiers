...
public class UltraImporterBlock extends CableBlock {
    ...
    {
        return new UltraImporterTileEntity();
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult hit)
    {
        if(!world.isRemote && CollisionUtils.isInBounds(this.getLineShape(state), pos, hit.getHitVec()))
        {
            ...
            {
                NetworkHooks.openGui((ServerPlayerEntity) player, new PositionalTileContainerProvider<UltraImporterTileEntity>(new TranslationTextComponent(this.getTranslationKey()), (tile, windowId, inventory, p) -> new UltraImporterContainer(windowId, player, tile), pos), pos);
            });
        }
