...
/**
 * Nearly exact copy of {@link com.refinedmods.refinedstorage.fabric.storage.diskinterface.DiskInterfaceBakedModel}
 */
class TieredDiskInterfaceBakedModel extends AbstractDiskContainerBakedModel {
    ...
    public void emitBlockQuads(final BlockAndTintGetter blockView,
                               ...
                               final Supplier<RandomSource> randomSupplier,
                               final RenderContext context) {
        if (!(state.getBlock() instanceof TieredDiskInterfaceBlock diskInterfaceBlock)) {
            return;
        }
