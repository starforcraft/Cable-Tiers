...
public abstract class AbstractTieredDiskInterfaceBlockEntityRenderer<T extends AbstractTieredDiskInterfaceBlockEntity>
    ...
    protected AbstractTieredDiskInterfaceBlockEntityRenderer(final RenderType renderType) {
    ...
    public void extractRenderState(final T blockEntity, final DiskLedsRenderState state, final float partialTicks,
        ...
        state.disks = this.extractDisks(blockEntity);
    ...
    public void submit(final DiskLedsRenderState state, final PoseStack poseStack,
        ...
        submitNodeCollector.submitCustomGeometry(poseStack, this.renderType, new DiskLedsCustomGeometryRenderer(
            state.direction,
            state.disks,
