...
import com.ultramega.cabletiers.common.mixin.LockModeInvoker;
...
/**
 * Exact copy of {@link com.refinedmods.refinedstorage.common.autocrafting.autocrafter.LockModeSideButtonWidget}
 */
class LockModeSideButtonWidget extends AbstractSideButtonWidget {
    ...
    private static OnPress createPressAction(final ClientProperty<LockMode> property) {
        return btn -> property.setValue(((LockModeInvoker) (Object) property.getValue()).cabletiers$toggle());
    }
