...
/**
 * Exact copy of {@link com.refinedmods.refinedstorage.common.constructordestructor.AutocraftOnMissingResourcesConstructorStrategy}
 */
        ...
        if (result == Result.RESOURCE_MISSING) {
            ...
            if (!autocrafting.getPatternsByOutput(resource).isEmpty()) {
                final long amount = resource instanceof PlatformResourceKey platformResource
                    ...
                    : 1L;
                final var ensureResult = autocrafting.ensureTask(resource, amount, actor, new TimeoutableCancellationToken());
